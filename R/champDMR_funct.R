...
### Load this function before using champ.DMR() in ChAMP_Analysis.R script ####

# Modification of the original function (https://rdrr.io/bioc/ChAMP/src/R/champ.DMR.R)
# has been done in the part of DMRCate method using the comment of user santanalele in
# the following link: https://github.com/YuanTian1991/ChAMP/issues/18
...
# mc.cores = cores --> this argument no longer applies:    
